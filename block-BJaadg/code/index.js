...
*/
console.log(`Does from starts with "A":`, from.startsWith(`A`));
console.log(`Does to starts with "A":`, to.startsWith(`A`));
console.log(`Does quote starts with "A":`, quote.startsWith(`A`));
